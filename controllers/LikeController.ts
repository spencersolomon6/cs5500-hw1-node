 ...
 *     </li>
 *     <li>GET /api/tuits/:tid/likes/count to retrieve a count of likes on a tuit
 *     </li>
 *     <li>POST /api/users/:uid/likes/:tid to record that a user likes a tuit
 *     </li>
 *     <li>DELETE /api/users/:uid/unlikes/:tid to record that a user
 *     no londer likes a tuit</li>
 *     <li>PUT /api/users/:uid/likes/:tid toggles the like status for this user on this tuit
 *     </li>
 * </ul>
...
export default class LikeController implements LikeControllerI {
     ...
     * @param {Request} req Represents request from client including the path
     * paramter tid representing the tuit to find the like count of 
     * @param {Response} res Represents response to client, including the body
     * formatted as JSON containing the like count   
     */
     ...
     * uid and tid representing the user that is liking the tuit and the tuit being liked 
    ...
    userTogglesTuitLikes = async (req: any, res: any) => {
        ...
        try {
            ...
            const howManyLikedTuit: number = await LikeController.likeDao
                .countHowManyLikedTuit(tid);
            const howManyDislikedTuit: number = await LikeController.dislikeDao
                .countHowManyDislikedTuit(tid);
            const tuit = await LikeController.tuitDao
                .findTuitById(tid);
